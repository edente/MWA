...
module.exports.gamesGetAllSearch = function(req,res){
    ...
    if(req.query && req.query.searchName){
    ...
    //Using Mongooose
    Game.find({title:searchName}).skip(offset).limit(count).exec(function(err,games){
